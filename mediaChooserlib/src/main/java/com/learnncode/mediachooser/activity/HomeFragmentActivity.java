...
public class HomeFragmentActivity extends FragmentActivity implements ImageFragment.OnImageSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backArrow = getResources().getDrawable(R.drawable.ic_back);
        backArrow.setColorFilter(getResources().getColor(R.color.text_color), PorterDuff.Mode.SRC_ATOP);
        headerBarBack.setImageDrawable(backArrow);


        Typeface custom_font = Typeface.createFromAsset(getAssets(), "SEGOEUI.TTF");
        headerBarDone.setTypeface(custom_font);
        ...
        for (int i = 0; i < mTabHost.getTabWidget().getChildCount(); i++) {
            ...
            textView.setTextColor(getResources().getColor(R.color.headerbar_selected_tab_color));
                ...
                if (videoFragment != null || imageFragment != null) {
                    ...
                    if (imageFragment != null) {
                        if (imageFragment.getSelectedImageList() != null && imageFragment.getSelectedImageList().size() > 0) {
                            imageFragment.getSelectedImageList().trimToSize();
    ...
    public void onBackPressed() {
        ...
        if (getIntent() != null && getIntent().getBooleanExtra("isFromBucket", false)) {
            final Intent intent = new Intent(this, BucketHomeFragmentActivity.class);
