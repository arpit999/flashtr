...
public abstract class SimpleOrientationListener extends OrientationEventListener {
    ...
    public void onOrientationChanged(final int orientation) {
        ...
        if (prevOrientation != currentOrientation && orientation != OrientationEventListener.ORIENTATION_UNKNOWN) {
            ...
            if (currentOrientation != OrientationEventListener.ORIENTATION_UNKNOWN)
                reportOrientationChanged(currentOrientation, orientation);
        }

    }

    private void reportOrientationChanged(final int currentOrientation, final int orientation) {
        ...
        onSimpleOrientationChanged(toReportOrientation, orientation);
    }
     ...
     */
    public abstract void onSimpleOrientationChanged(int orientation, int rotation);
