 ...
 */
public class GridRecentPicsAdapter extends BaseAdapter {
    ...
    public GridRecentPicsAdapter(Context mContext, ArrayList<HashMap<String, String>> locallist) {
    ...
    public View getView(final int position, View view,
        ...
        /*imageLoader.displayImage(Uri.fromFile(new File("" + hashMap.get("photo"))).toString(), holder.imageView, options);*/
            Picasso.with(mContext).load(Uri.fromFile(new File("" + hashMap.get("photo")))).resize(400, 400).centerCrop().into(holder.imageView);
