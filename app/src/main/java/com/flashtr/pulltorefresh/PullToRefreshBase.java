package com.flashtr.pulltorefresh;
...
// ===========================================================
    ...
    private com.flashtr.pulltorefresh.LoadLayout mHeaderLayout;
    private com.flashtr.pulltorefresh.LoadLayout mFooterLayout;
...
// ===========================================================
     ...
     *
     * @param releaseLabel - String to display
     * @param mode         - Mode to use depending on which label you want to change
     */
...
// ===========================================================
    ...
    protected final com.flashtr.pulltorefresh.LoadLayout getFooterLayout() {
        return mFooterLayout;
    }

    protected final com.flashtr.pulltorefresh.LoadLayout getHeaderLayout() {
...
// We need to create now layouts now
        mHeaderLayout = new com.flashtr.pulltorefresh.LoadLayout(context, Mode.PULL_DOWN_TO_REFRESH, a);
        mFooterLayout = new com.flashtr.pulltorefresh.LoadLayout(context, Mode.PULL_UP_TO_REFRESH, a);
